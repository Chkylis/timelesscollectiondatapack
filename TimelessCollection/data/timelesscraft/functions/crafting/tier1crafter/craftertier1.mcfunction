...
execute if block ~ ~ ~ dropper{Items:[{Slot:0b,id:"minecraft:diamond",Count:1b},{Slot:1b,id:"minecraft:diamond",Count:1b},{Slot:2b,id:"minecraft:diamond",Count:1b},{Slot:3b,id:"minecraft:diamond",Count:1b},{Slot:4b,id:"minecraft:crafting_table",Count:1b},{Slot:5b,id:"minecraft:diamond",Count:1b},{Slot:6b,id:"minecraft:diamond",Count:1b},{Slot:7b,id:"minecraft:diamond",Count:1b},{Slot:8b,id:"minecraft:diamond",Count:1b}]} unless data block ~ ~ ~ Items[9] run function timelesscraft:crafting/tier2crafter/summontier2

###################################
######### DISMANTLE ################

execute if block ~ ~ ~ dropper{Items:[{id:"minecraft:paper",Count:1b,tag:{display:{Name:'{"text":"REFUND CUSTOM CRAFTER"}'}}}]} unless data block ~ ~ ~ Items[1] run function timelesscraft:dismantling/refundtier1
