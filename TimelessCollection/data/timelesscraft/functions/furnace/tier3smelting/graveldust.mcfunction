...
execute if score @s ticomsmeltitem matches 3 if score @s ticomsmelter matches 2 run data merge block ~ ~ ~ {Items:[{Slot:4b,id:"minecraft:iron_ingot",Count:20b},{Slot:7b,id:"minecraft:iron_nugget",Count:16b}]}
