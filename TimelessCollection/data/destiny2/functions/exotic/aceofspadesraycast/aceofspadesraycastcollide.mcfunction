...
scoreboard players set .distance aosrcast 450
...
execute as @s[nbt=!{Invulnerable:1b},scores={mobHealth=23..},type=!ender_dragon] store result entity @s Health float 1 run scoreboard players remove @s mobHealth 18
execute as @s[nbt=!{Invulnerable:1b},scores={mobHealth=600..},type=ender_dragon] store result entity @s Health float 1 run scoreboard players remove @s mobHealth 2
execute as @s[nbt=!{Invulnerable:1b},scores={mobHealth=600..},type=wither] store result entity @s Health float 1 run scoreboard players remove @s mobHealth 2
...
execute as @e if score @s mobHealth matches ..1 run scoreboard players set @p[nbt={SelectedItem:{id:'minecraft:carrot_on_a_stick',tag:{aceofspades:1b}}}] mementomori 6
execute as @s if score @s mobHealth matches ..1 run scoreboard players reset @s mobHealth
