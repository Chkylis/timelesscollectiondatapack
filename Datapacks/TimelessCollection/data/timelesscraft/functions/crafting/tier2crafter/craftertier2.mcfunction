...
execute if block ~ ~ ~ dropper{Items:[{Slot:1b,id:"minecraft:netherite_ingot",Count:1b},{Slot:3b,id:"minecraft:netherite_ingot",Count:1b},{Slot:4b,id:"minecraft:crafting_table",Count:1b},{Slot:5b,id:"minecraft:netherite_ingot",Count:1b},{Slot:7b,id:"minecraft:netherite_ingot",Count:1b}]} unless data block ~ ~ ~ Items[5] run function timelesscraft:crafting/tier3crafter/summontier3

###################################
######### DISMANTLE ################

execute if block ~ ~ ~ dropper{Items:[{id:"minecraft:paper",Count:1b,tag:{display:{Name:'{"text":"REFUND CUSTOM CRAFTER"}'}}}]} unless data block ~ ~ ~ Items[1] run function timelesscraft:dismantling/refundtier2
